...
return [
    ...
    'profile_email_not_verified' => 'Votre adresse e-mail n\'est pas vérifiée.',
    'profile_email_send_verification_link' => 'Cliquez ici pour renvoyer l\'e-mail de vérification.',
    'profile_email_verification_sent' => 'Un nouveau lien de vérification a été envoyé à votre adresse e-mail.',
    'profile_save' => 'Enregistrer',
    'profile_updated' => 'Enregistré.',

    'profile_delete_title' => 'Supprimer le compte',
    'profile_delete_description' => 'Supprimer votre compte et toutes ses ressources',
    'profile_delete_warning_title' => 'Avertissement',
    'profile_delete_warning_description' => 'Veuillez procéder avec prudence, cette action est irréversible.',
    'profile_delete' => 'Supprimer le compte',

    'profile_delete_modal_title' => 'Êtes-vous sûr de vouloir supprimer votre compte ?',
    'profile_delete_modal_description' => 'Une fois votre compte supprimé, toutes ses ressources et données seront également supprimées définitivement. Veuillez saisir votre mot de passe pour confirmer que vous souhaitez supprimer définitivement votre compte.',
    'profile_delete_modal_password' => 'Mot de passe',
