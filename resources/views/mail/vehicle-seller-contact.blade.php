@php
    ...
    $vehicleTitle = trim(sprintf(
        '%s %s',
        (string) ($vehicleAd->brand?->name ?? ''),
        (string) ($vehicleAd->model?->name ?? ''),
    ));
    ...
    $vehiclePrice = $vehicleAd->price !== null
        ? number_format((float) $vehicleAd->price, 2, ',', ' ').' EUR'
        : '-';
@endphp
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:680px;background:#ffffff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
                ...
                <tr>
                    <td style="padding:24px;">
                        <p style="margin:0 0 6px 0;font-size:32px;font-weight:700;line-height:1.2;">Nouvelle demande de contact</p>
                        <p style="margin:0 0 20px 0;font-size:15px;line-height:1.55;color:#4b5563;">Un acheteur potentiel vous a envoye un message depuis la fiche vehicule.</p>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:16px;">
                            <tr>
                                <td style="padding:14px 16px;background:#f9fafb;border-bottom:1px solid #e5e7eb;font-weight:700;">Annonce</td>
                            </tr>
                            <tr>
                                <td style="padding:14px 16px;font-size:14px;line-height:1.7;">
                                    <strong>Vehicule :</strong> {{ $vehicleTitle !== '' ? $vehicleTitle : '-' }}<br>
                                    <strong>ID annonce :</strong> {{ $vehicleAd->id }}<br>
                                    <strong>Prix :</strong> {{ $vehiclePrice }}
                                </td>
                            </tr>
                        </table>
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e5e7eb;border-radius:10px;margin-bottom:16px;">
                            <tr>
                                <td style="padding:14px 16px;background:#f9fafb;border-bottom:1px solid #e5e7eb;font-weight:700;">Contact acheteur</td>
                            </tr>
                            <tr>
                                <td style="padding:14px 16px;font-size:14px;line-height:1.7;">
                        ...
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top:4px;">
                            <tr>
                                <td align="center">
                                    <a
                                        href="{{ route('vehicles.show', $vehicleAd) }}"
                ...
                <tr>
                    <td style="background:#1c2631;border-top:3px solid #f43f5e;padding:14px 24px;text-align:center;">
                        <p style="margin:0;font-size:12px;line-height:1.5;color:#cbd5e1;">
                            © 2026 AutoSaler — Tous droits reserves.
                        </p>
                    </td>
                </tr>
            </table>
