                ...
                >
                    <div v-if="showInstructions" class="space-y-3">
                        <div class="flex items-center gap-x-3">
                            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/10 shadow-inner">
                                <Smartphone class="h-5 w-5 text-white" />
                            </div>
                            <div class="flex-1">
                                <p class="text-[10px] font-black tracking-widest text-white/40 uppercase">
                        ...
                        <div class="space-y-2.5 px-1 py-1">
                            <div class="flex items-start gap-x-3 text-white">
                                <span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/10 text-[10px] font-black">1</span>
                                <p class="text-xs font-medium">{{ __('pwa.ios_guide_step_1') }}</p>
                            </div>
                            <div class="flex items-start gap-x-3 text-white">
                                <span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-white/10 text-[10px] font-black">2</span>
                                <p class="text-xs font-medium">{{ __('pwa.ios_guide_step_2') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-else class="flex items-center gap-x-3">
                        ...
                        <div class="flex items-center gap-2">
                            <Button
                                ...
                                @click="showIosInstallMessage ? (showInstructions = true) : install()"
                            >
                                {{ __('pwa.button') }}
                            </Button>
