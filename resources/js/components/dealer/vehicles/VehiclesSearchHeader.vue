...
<template>
    <div class="flex items-center gap-3">
        ...
        <Button
            ...
            class="h-10 gap-2 border border-transparent px-4 transition-all hover:border-border hover:bg-background hover:shadow-sm"
        ...
        >
            ...
            />
            <span class="text-sm font-medium">{{ __('ui.filters') }}</span>
