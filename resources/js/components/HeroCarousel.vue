...
<template>
<div class="absolute inset-0 overflow-hidden bg-neutral-950" @touchstart.passive="onTouchStart" @touchend.passive="onTouchEnd">

  <!-- Images de bg -->
  <div v-for="(slide, i) in slides" :key="'img-'+i" class="absolute inset-0">
    <img
      :src="slide.image"
