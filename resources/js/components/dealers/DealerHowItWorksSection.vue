...
const cards: HowItWorksCard[] = [
    {
        titleKey: 'dealerPage.how_it_works_card_1_title',
        descriptionKey: 'dealerPage.how_it_works_card_1_description',
        icon: ShieldCheck,
    },
    {
    ...
    },
    {
        ...
        descriptionKey: 'dealerPage.how_it_works_card_6_description',
        icon: BarChart3,
    },
];
</script>
    ...
    <section class="relative overflow-hidden py-16 md:py-24">
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <h2 class="mt-6 text-balance text-3xl font-extrabold tracking-tight text-foreground uppercase">
                    {{ __('dealerPage.how_it_works_title_before') }}
                    <span class="text-primary">{{ __('dealerPage.how_it_works_title_highlight') }}</span>
                    {{ __('dealerPage.how_it_works_title_after') }}
                </h2>

                <p class="mx-auto mt-5 max-w-2xl  leading-relaxed text-muted-foreground ">
                    {{ __('dealerPage.how_it_works_subtitle') }}
                </p>
            </div>
            ...
            <div class="mt-14 grid gap-4 md:grid-cols-3">
                ...
                >
                    <div class="flex items-start gap-4">
                        ...
                        <div class="min-w-0">
                            <h3 class="text-base font-bold tracking-tight text-card-foreground">
                                {{ __(card.titleKey) }}
                            </h3>

                            <p class="mt-2 text-sm leading-relaxed text-muted-foreground">
                                {{ __(card.descriptionKey) }}
                            </p>
                        </div>
                    </div>
                </Card>
