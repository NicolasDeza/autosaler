        ...
        >
            ...
            <div class="hidden p-6 lg:block">
                ...
                <div class="mb-6 grid grid-cols-2 gap-3">
                    ...
                    >
                        <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current text-[#25D366] transition-transform group-hover:scale-110">
                        ...
                        <span class="text-[10px] font-bold tracking-tight text-[#25D366] uppercase">WhatsApp</span>
                    </a>
