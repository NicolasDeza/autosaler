...
<template>
    <div
        class="dark group/contact relative aspect-2/1 overflow-hidden rounded-t-lg"
    >
        ...
        <div
            class="pointer-events-none relative z-20 flex h-full flex-col justify-end border-b border-border/50 px-6 pb-8 text-foreground"
        >
            <div class="flex items-start justify-between">
                <div class="flex items-start gap-4">
                    <!-- Company Logo Area -->
                    <div class="group/logo pointer-events-auto relative">
                        <Avatar
                            :class="[
                                'size-16 shrink-0 border-2 border-border/50 bg-card shadow-lg ring-4 ring-primary/5 transition-all duration-300 group-hover/contact:scale-105',
                    ...
                    <div class="pointer-events-auto space-y-3">
                        ...
                        <div class="space-y-1">
                            ...
                            <p
                                ...
                                v-if="memberSince"
                            >
                                {{ __('ui.member_since') || 'Membre depuis' }}
                                {{ memberSince }}
                            </p>
                        </div>
                    </div>
                ...
                <a
                    ...
                    class="group/wa pointer-events-auto relative flex h-12 w-12 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-lg shadow-[#25D366]/20 transition-all hover:scale-110 hover:shadow-[#25D366]/40 active:scale-95"
                    title="WhatsApp"
                >
